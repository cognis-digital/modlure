"""modpot.probe — AUTHORIZATION-GATED active Modbus client probe.

MODPOT is a DEFENSIVE Modbus TCP tool. Everything else in this package is
...
illegal and unsafe on a live OT/ICS network. Therefore active mode is:
  ...
  * **OFF by default.** It only runs from ``modpot probe`` with ``--authorized``.
...
AUTHORIZED_USE_BANNER = (
    "================================================================\n"
    " modpot ACTIVE PROBE — AUTHORIZED USE ONLY\n"
