#!/usr/bin/env sh
# Universal installer for modlure. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/modlure.git"
echo "Installing modlure ..."
